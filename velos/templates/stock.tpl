{include file="admin/_head.tpl" title="État du stock de vélos" current="plugin_`$plugin.id`"}

{include file="`$plugin_tpl`_nav.tpl" current="stock"}
...
<section class="stock">
    ...
    <article class="etiquettes">
        ...
        <p>
            {foreach from=$a_demonter value="num"}
        ...
        <p>
            {foreach from=$en_vente key="num" value="prix"}
