...
<form method="post" action="{$self_url}">
	...
	<fieldset>
		...
		<dl>
			...
			{input type="list" target="!acc/charts/accounts/selector.php?types=6&key=code" name="donation_account_code" label="Compte de recette pour les dons reçus" default=$donation_account can_delete=true}
		</dl>
	</fieldset>
