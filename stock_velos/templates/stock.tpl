...
<section class="stock">
	...
	<article class="etiquettes">
		...
		<p>
			...
			<a href="fiche.php?id={$r.id}" class="a_demonter">{if $r.etiquette && $fields.etiquette.enabled}{$r.etiquette}{else}{$r.id}{/if}</a>
			{/foreach}
		</p>
	</article>
	<article class="etiquettes">
	...
	<article class="etiquettes">
		...
		<p>
			...
			<a href="fiche.php?id={$r.id}" class="en_stock">{if $r.etiquette && $fields.etiquette.enabled}{$r.etiquette}{else}{$r.id}{/if}</a>
			{/foreach}
		</p>
	</article>
