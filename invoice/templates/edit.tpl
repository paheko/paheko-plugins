...
<fieldset>
	...
	<dl>
		...
		{input required=false name="notes" type="textarea" cols=50 rows=5 label="Notes supplémentaires" source=$invoice help="Ces informations figureront sur le document" source=$invoice}
	</dl>
	{if !$invoice->isQuote()}
	<details>
